...
const Foam::scalar Foam::interfacePropertiesAR::convertToRad =
...
void Foam::interfacePropertiesAR::correctContactAngle
(
...
void Foam::interfacePropertiesAR::calculateK()
{
    const fvMesh& mesh = alpha1_.mesh();
...
void Foam::interfacePropertiesAR::calculatePhic()
{
	const fvMesh& mesh = alpha1_.mesh();
...
Foam::interfacePropertiesAR::interfacePropertiesAR
(
